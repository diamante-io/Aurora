...
This is a small tool, written in Go, for working with `diamnet-core` history archives directly.
It is a standalone tool that does not require `diamnet-core`, or any other programs.

It is much smaller and simpler than `diamnet-core`, and is intended only for archive-maintenance tasks.
...
```
$ go install github.com/diamnet/go/tools/diamnet-archivist
```

## Usage

```
inspect diamnet history archive

Usage:
  diamnet-archivist [flags]
  diamnet-archivist [command]
...
Flags:
  ...
  -h, --help              help for diamnet-archivist
...
Use "diamnet-archivist [command] --help" for more information about a command.
```

## Specifying history archives

Unlike `diamnet-core`, `diamnet-archivist` does not run subprocesses to access history archives;
...
`diamnet-archivist` supports reading from and writing to any S3-compatible storage.
...
```
$ diamnet-archivist status --s3endpoint ams3.digitaloceanspaces.com s3://bucketname/prefix
```
...
$ diamnet-archivist status --s3endpoint https://storage.googleapis.com s3://google-storage-bucketname
``` 
...
```
$ diamnet-archivist status http://s3-eu-west-1.amazonaws.com/history.diamnet.org/prd/core-testnet/core_testnet_001

       Archive: http://s3-eu-west-1.amazonaws.com/history.diamnet.org/prd/core-testnet/core_testnet_001
...
```
$ diamnet-archivist mirror http://s3-eu-west-1.amazonaws.com/history.diamnet.org/prd/core-testnet/core_testnet_001 file://local-archive

2016/02/10 18:27:09 mirroring http://s3-eu-west-1.amazonaws.com/history.diamnet.org/prd/core-testnet/core_testnet_001 -> file://local-archive
...
```
$ diamnet-archivist mirror --recent http://history.diamnet.org/prd/core-live/core_live_001 file://local-archive

2019/08/21 13:53:15 mirroring http://history.diamnet.org/prd/core-live/core_live_001 -> file://local-archive
...
```
$ diamnet-archivist --last 1024 mirror http://history.diamnet.org/prd/core-testnet/core_testnet_001 file://local-archive

2016/02/10 19:14:01 mirroring http://s3-eu-west-1.amazonaws.com/history.diamnet.org/prd/core-testnet/core_testnet_001 -> file://local-archive
...
```
$ diamnet-archivist scan file://local-archive
...
```
$ diamnet-archivist --last 4096 scan file://local-archive
...
$ diamnet-archivist --low 1000000 --high 1006000 scan file://local-archive
...
```
$ diamnet-archivist --verify --last 4096 scan file://local-archive
...
$ diamnet-archivist repair file://local-archive file://broken-archive
...
```
 diamnet-archivist dumpxdr local-archive/transactions//00/20/de/transactions-0020de7f.xdr.gz
