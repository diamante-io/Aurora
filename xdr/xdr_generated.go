...
import (
	...
	"github.com/diamnet/go-xdr/xdr3"
)
...
// EncodeTo encodes this value using the Encoder.
func (e DiamnetValueType) EncodeTo(enc *xdr.Encoder) error {
	if _, ok := diamnetValueTypeMap[int32(e)]; !ok {
		return fmt.Errorf("'%d' is not a valid DiamnetValueType enum value", e)
	}
	_, err := enc.EncodeInt(int32(e))
	return err
}

var _ decoderFrom = (*DiamnetValueType)(nil)

// DecodeFrom decodes this value using the Decoder.
func (e *DiamnetValueType) DecodeFrom(d *xdr.Decoder) (int, error) {
	v, n, err := d.DecodeInt()
	if err != nil {
		return n, fmt.Errorf("decoding DiamnetValueType: %s", err)
	}
	if _, ok := diamnetValueTypeMap[v]; !ok {
		return n, fmt.Errorf("'%d' is not a valid DiamnetValueType enum value", v)
	}
	*e = DiamnetValueType(v)
	return n, nil
}
...
// xdrType signals that this type is an type representing
// representing XDR values defined by this package.
func (s DiamnetValueType) xdrType() {}

var _ xdrType = (*DiamnetValueType)(nil)
...
// EncodeTo encodes this value using the Encoder.
func (u DiamnetValueExt) EncodeTo(e *xdr.Encoder) error {
	var err error
	if err = u.V.EncodeTo(e); err != nil {
		return err
	}
	switch DiamnetValueType(u.V) {
	case DiamnetValueTypeDiamnetValueBasic:
		// Void
		return nil
	case DiamnetValueTypeDiamnetValueSigned:
	...
	return fmt.Errorf("V (DiamnetValueType) switch value '%d' is not valid for union DiamnetValueExt", u.V)
}

var _ decoderFrom = (*DiamnetValueExt)(nil)

// DecodeFrom decodes this value using the Decoder.
func (u *DiamnetValueExt) DecodeFrom(d *xdr.Decoder) (int, error) {
	var err error
	var n, nTmp int
	...
	return n, fmt.Errorf("union DiamnetValueExt has invalid V (DiamnetValueType) switch value '%d'", u.V)
}
...
// xdrType signals that this type is an type representing
// representing XDR values defined by this package.
func (s DiamnetValueExt) xdrType() {}

var _ xdrType = (*DiamnetValueExt)(nil)
...
// EncodeTo encodes this value using the Encoder.
func (s *DiamnetValue) EncodeTo(e *xdr.Encoder) error {
	var err error
...
var _ decoderFrom = (*DiamnetValue)(nil)

// DecodeFrom decodes this value using the Decoder.
func (s *DiamnetValue) DecodeFrom(d *xdr.Decoder) (int, error) {
	var err error
	var n, nTmp int
	...
	n += nTmp
	if err != nil {
		return n, fmt.Errorf("decoding DiamnetValueExt: %s", err)
	}
	return n, nil
}
...
// xdrType signals that this type is an type representing
// representing XDR values defined by this package.
func (s DiamnetValue) xdrType() {}

var _ xdrType = (*DiamnetValue)(nil)
...
func (s *LedgerHeader) DecodeFrom(d *xdr.Decoder) (int, error) {
	...
	n += nTmp
	if err != nil {
		return n, fmt.Errorf("decoding DiamnetValue: %s", err)
	}
...
// EncodeTo encodes this value using the Encoder.
func (u DiamnetMessage) EncodeTo(e *xdr.Encoder) error {
	var err error
	if err = u.Type.EncodeTo(e); err != nil {
		return err
	}
	...
	return fmt.Errorf("Type (MessageType) switch value '%d' is not valid for union DiamnetMessage", u.Type)
}

var _ decoderFrom = (*DiamnetMessage)(nil)

// DecodeFrom decodes this value using the Decoder.
func (u *DiamnetMessage) DecodeFrom(d *xdr.Decoder) (int, error) {
	var err error
	var n, nTmp int
	nTmp, err = u.Type.DecodeFrom(d)
	n += nTmp
	...
	return n, fmt.Errorf("union DiamnetMessage has invalid Type (MessageType) switch value '%d'", u.Type)
}
...
// xdrType signals that this type is an type representing
// representing XDR values defined by this package.
func (s DiamnetMessage) xdrType() {}

var _ xdrType = (*DiamnetMessage)(nil)
...
func (s *AuthenticatedMessageV0) DecodeFrom(d *xdr.Decoder) (int, error) {
	...
	n += nTmp
	if err != nil {
		return n, fmt.Errorf("decoding DiamnetMessage: %s", err)
	}
