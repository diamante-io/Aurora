...
// account id.
// Deprecated: use clients/auroraclient instead
...
// LoadAccount loads the account state from aurora. err can be either error
// object or aurora.Error object.
// Deprecated: use auroraclient.AccountDetail instead
...
// LoadAccountOffers loads the account offers from aurora. err can be either
// error object or aurora.Error object.
// Deprecated: use auroraclient.Offers instead
...
// LoadTradeAggregations loads the trade aggregation from aurora.
// Deprecated: use auroraclient.TradeAggregations instead
...
// LoadTrades loads the /trades endpoint from aurora.
// Deprecated: use auroraclient.Trades instead
...
// LoadTransaction loads a single transaction from Aurora server
// Deprecated: use auroraclient.TransactionDetail instead
...
// Deprecated: use auroraclient.Transactions instead
...
// LoadOperation loads a single operation from Aurora server
// Deprecated: use auroraclient.OperationDetail instead
...
// Deprecated: use auroraclient.OrderBook instead
...
// Deprecated: use auroraclient.StreamLedgers instead
...
// Deprecated: use auroraclient.StreamPayments instead
...
// context.Background() if you want to stream indefinitely.
// Deprecated: use auroraclient.StreamTransactions instead
...
// Deprecated: use auroraclient.SubmitTransactionXDR instead
