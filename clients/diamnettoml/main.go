...
type ClientInterface interface {
	...
	GetDiamnetTomlByAddress(addr string) (*Response, error)
}
...
// SEP-1 commit
// https://github.com/diamnet/diamnet-protocol/blob/f8993e36fa6b5b8bba1254c21c2174d250af4958/ecosystem/sep-0001.md
...
// given address
func GetDiamnetTomlByAddress(addr string) (*Response, error) {
	return DefaultClient.GetDiamnetTomlByAddress(addr)
}
