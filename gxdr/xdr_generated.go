// Code generated by goxdr -p gxdr -enum-comments -o gxdr/xdr_generated.go xdr/Diamnet-SCP.x xdr/Diamnet-ledger-entries.x xdr/Diamnet-ledger.x xdr/Diamnet-overlay.x xdr/Diamnet-transaction.x xdr/Diamnet-types.x; DO NOT EDIT.
...
const (
	DIAMNET_VALUE_BASIC  DiamnetValueType = 0
	DIAMNET_VALUE_SIGNED DiamnetValueType = 1
)
...
type DiamnetValue struct {
	...
	Ext      XdrAnon_DiamnetValue_Ext
}

// reserved for future use
type XdrAnon_DiamnetValue_Ext struct {
	// The union discriminant V selects among the following arms:
	//   DIAMNET_VALUE_BASIC:
	//      void
...
var _XdrNames_DiamnetValueType = map[int32]string{
	int32(DIAMNET_VALUE_BASIC):  "DIAMNET_VALUE_BASIC",
	int32(DIAMNET_VALUE_SIGNED): "DIAMNET_VALUE_SIGNED",
}
var _XdrValues_DiamnetValueType = map[string]int32{
	"DIAMNET_VALUE_BASIC":  int32(DIAMNET_VALUE_BASIC),
	"DIAMNET_VALUE_SIGNED": int32(DIAMNET_VALUE_SIGNED),
}

func (DiamnetValueType) XdrEnumNames() map[int32]string {
	return _XdrNames_DiamnetValueType
}
func (v DiamnetValueType) String() string {
	if s, ok := _XdrNames_DiamnetValueType[int32(v)]; ok {
		return s
	}
	return fmt.Sprintf("DiamnetValueType#%d", v)
}
func (v *DiamnetValueType) Scan(ss fmt.ScanState, _ rune) error {
	if tok, err := ss.Token(true, XdrSymChar); err != nil {
		return err
	} else {
		stok := string(tok)
		if val, ok := _XdrValues_DiamnetValueType[stok]; ok {
			*v = DiamnetValueType(val)
			return nil
		} else if stok == "DiamnetValueType" {
			if n, err := fmt.Fscanf(ss, "#%d", (*int32)(v)); n == 1 && err == nil {
				return nil
			}
		}
		return XdrError(fmt.Sprintf("%s is not a valid DiamnetValueType.", stok))
	}
}
func (v DiamnetValueType) GetU32() uint32                 { return uint32(v) }
func (v *DiamnetValueType) SetU32(n uint32)               { *v = DiamnetValueType(n) }
func (v *DiamnetValueType) XdrPointer() interface{}       { return v }
func (DiamnetValueType) XdrTypeName() string              { return "DiamnetValueType" }
func (v DiamnetValueType) XdrValue() interface{}          { return v }
func (v *DiamnetValueType) XdrMarshal(x XDR, name string) { x.Marshal(name, v) }

type XdrType_DiamnetValueType = *DiamnetValueType

func XDR_DiamnetValueType(v *DiamnetValueType) *DiamnetValueType { return v }
...
var _XdrTags_XdrAnon_DiamnetValue_Ext = map[int32]bool{
	XdrToI32(DIAMNET_VALUE_BASIC):  true,
	XdrToI32(DIAMNET_VALUE_SIGNED): true,
}

func (_ XdrAnon_DiamnetValue_Ext) XdrValidTags() map[int32]bool {
	return _XdrTags_XdrAnon_DiamnetValue_Ext
}
func (u *XdrAnon_DiamnetValue_Ext) LcValueSignature() *LedgerCloseValueSignature {
	switch u.V {
	...
	default:
		XdrPanic("XdrAnon_DiamnetValue_Ext.LcValueSignature accessed when V == %v", u.V)
		return nil
	}
}
func (u XdrAnon_DiamnetValue_Ext) XdrValid() bool {
	switch u.V {
	case DIAMNET_VALUE_BASIC, DIAMNET_VALUE_SIGNED:
		return true
	}
	return false
}
func (u *XdrAnon_DiamnetValue_Ext) XdrUnionTag() XdrNum32 {
	return XDR_DiamnetValueType(&u.V)
}
func (u *XdrAnon_DiamnetValue_Ext) XdrUnionTagName() string {
	return "V"
}
func (u *XdrAnon_DiamnetValue_Ext) XdrUnionBody() XdrType {
	switch u.V {
...
func (u *XdrAnon_DiamnetValue_Ext) XdrUnionBodyName() string {
	switch u.V {
	case DIAMNET_VALUE_BASIC:
		return ""
	case DIAMNET_VALUE_SIGNED:
...
type XdrType_XdrAnon_DiamnetValue_Ext = *XdrAnon_DiamnetValue_Ext

func (v *XdrAnon_DiamnetValue_Ext) XdrPointer() interface{}       { return v }
func (XdrAnon_DiamnetValue_Ext) XdrTypeName() string              { return "XdrAnon_DiamnetValue_Ext" }
func (v XdrAnon_DiamnetValue_Ext) XdrValue() interface{}          { return v }
func (v *XdrAnon_DiamnetValue_Ext) XdrMarshal(x XDR, name string) { x.Marshal(name, v) }
func (u *XdrAnon_DiamnetValue_Ext) XdrRecurse(x XDR, name string) {
	if name != "" {
		name = x.Sprintf("%s.", name)
	}
	XDR_DiamnetValueType(&u.V).XdrMarshal(x, x.Sprintf("%sv", name))
	switch u.V {
	case DIAMNET_VALUE_BASIC:
		return
	case DIAMNET_VALUE_SIGNED:
	...
	XdrPanic("invalid V (%v) in XdrAnon_DiamnetValue_Ext", u.V)
}
func XDR_XdrAnon_DiamnetValue_Ext(v *XdrAnon_DiamnetValue_Ext) *XdrAnon_DiamnetValue_Ext { return v }
...
type XdrType_DiamnetValue = *DiamnetValue

func (v *DiamnetValue) XdrPointer() interface{}       { return v }
func (DiamnetValue) XdrTypeName() string              { return "DiamnetValue" }
func (v DiamnetValue) XdrValue() interface{}          { return v }
func (v *DiamnetValue) XdrMarshal(x XDR, name string) { x.Marshal(name, v) }
func (v *DiamnetValue) XdrRecurse(x XDR, name string) {
	if name != "" {
		name = x.Sprintf("%s.", name)
	}
	...
	x.Marshal(x.Sprintf("%sext", name), XDR_XdrAnon_DiamnetValue_Ext(&v.Ext))
}
func XDR_DiamnetValue(v *DiamnetValue) *DiamnetValue { return v }
...
func (v *LedgerHeader) XdrRecurse(x XDR, name string) {
	...
	x.Marshal(x.Sprintf("%sscpValue", name), XDR_DiamnetValue(&v.ScpValue))
...
var _XdrTags_DiamnetMessage = map[int32]bool{
...
func (_ DiamnetMessage) XdrValidTags() map[int32]bool {
	return _XdrTags_DiamnetMessage
}
func (u *DiamnetMessage) Error() *Error {
	switch u.Type {
	case ERROR_MSG:
	...
	default:
		XdrPanic("DiamnetMessage.Error accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *DiamnetMessage) Hello() *Hello {
	switch u.Type {
	case HELLO:
	...
	default:
		XdrPanic("DiamnetMessage.Hello accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *DiamnetMessage) Auth() *Auth {
	switch u.Type {
	case AUTH:
	...
	default:
		XdrPanic("DiamnetMessage.Auth accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *DiamnetMessage) DontHave() *DontHave {
	switch u.Type {
	case DONT_HAVE:
	...
	default:
		XdrPanic("DiamnetMessage.DontHave accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *DiamnetMessage) Peers() *[]PeerAddress {
	switch u.Type {
	case PEERS:
	...
	default:
		XdrPanic("DiamnetMessage.Peers accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *DiamnetMessage) TxSetHash() *Uint256 {
	switch u.Type {
	case GET_TX_SET:
	...
	default:
		XdrPanic("DiamnetMessage.TxSetHash accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *DiamnetMessage) TxSet() *TransactionSet {
	switch u.Type {
	case TX_SET:
	...
	default:
		XdrPanic("DiamnetMessage.TxSet accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *DiamnetMessage) Transaction() *TransactionEnvelope {
	switch u.Type {
	case TRANSACTION:
	...
	default:
		XdrPanic("DiamnetMessage.Transaction accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *DiamnetMessage) SignedSurveyRequestMessage() *SignedSurveyRequestMessage {
	switch u.Type {
	case SURVEY_REQUEST:
	...
	default:
		XdrPanic("DiamnetMessage.SignedSurveyRequestMessage accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *DiamnetMessage) SignedSurveyResponseMessage() *SignedSurveyResponseMessage {
	switch u.Type {
	...
	default:
		XdrPanic("DiamnetMessage.SignedSurveyResponseMessage accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *DiamnetMessage) QSetHash() *Uint256 {
	switch u.Type {
	...
	default:
		XdrPanic("DiamnetMessage.QSetHash accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *DiamnetMessage) QSet() *SCPQuorumSet {
	switch u.Type {
	case SCP_QUORUMSET:
	...
	default:
		XdrPanic("DiamnetMessage.QSet accessed when Type == %v", u.Type)
		return nil
	}
}
func (u *DiamnetMessage) Envelope() *SCPEnvelope {
	switch u.Type {
	case SCP_MESSAGE:
	...
	default:
		XdrPanic("DiamnetMessage.Envelope accessed when Type == %v", u.Type)
		return nil
	}
}

// ledger seq requested ; if 0, requests the latest
func (u *DiamnetMessage) GetSCPLedgerSeq() *Uint32 {
	switch u.Type {
	case GET_SCP_STATE:
		if v, ok := u._u.(*Uint32); ok {
			return v
	...
	default:
		XdrPanic("DiamnetMessage.GetSCPLedgerSeq accessed when Type == %v", u.Type)
		return nil
	}
}
func (u DiamnetMessage) XdrValid() bool {
	switch u.Type {
...
func (u *DiamnetMessage) XdrUnionTag() XdrNum32 {
	return XDR_MessageType(&u.Type)
}
func (u *DiamnetMessage) XdrUnionTagName() string {
	return "Type"
}
func (u *DiamnetMessage) XdrUnionBody() XdrType {
	switch u.Type {
	case ERROR_MSG:
...
func (u *DiamnetMessage) XdrUnionBodyName() string {
	switch u.Type {
	case ERROR_MSG:
		return "Error"
	case HELLO:
...
type XdrType_DiamnetMessage = *DiamnetMessage

func (v *DiamnetMessage) XdrPointer() interface{}       { return v }
func (DiamnetMessage) XdrTypeName() string              { return "DiamnetMessage" }
func (v DiamnetMessage) XdrValue() interface{}          { return v }
func (v *DiamnetMessage) XdrMarshal(x XDR, name string) { x.Marshal(name, v) }
func (u *DiamnetMessage) XdrRecurse(x XDR, name string) {
	if name != "" {
		name = x.Sprintf("%s.", name)
	}
	...
	XdrPanic("invalid Type (%v) in DiamnetMessage", u.Type)
}
func XDR_DiamnetMessage(v *DiamnetMessage) *DiamnetMessage { return v }
...
func (v *XdrAnon_AuthenticatedMessage_V0) XdrRecurse(x XDR, name string) {
	...
	x.Marshal(x.Sprintf("%smessage", name), XDR_DiamnetMessage(&v.Message))
