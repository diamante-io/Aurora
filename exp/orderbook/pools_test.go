...
// pool calculation functions are correct, taken from Diamnet Core's tests here:
//
// https://github.com/diamnet/diamnet-core/blob/master/src/transactions/test/ExchangeTests.cpp#L948
