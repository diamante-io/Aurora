...
// MinBaseFee is the minimum transaction fee for the Diamnet network of 100 stroops (0.00001 XLM).
const MinBaseFee = 100

// Account represents the aspects of a Diamnet account necessary to construct transactions. See
// https://developers.diamnet.org/docs/glossary/accounts/
...
// https://developers.diamnet.org/docs/glossary/transactions/
...
// See description here: https://developers.diamnet.org/docs/glossary/multisig/#hashx
