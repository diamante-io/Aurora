...
replacement: https://developers.diamnet.org/api/aggregations/paths/strict-receive/
---
...
```sh
curl "https://aurora-testnet.diamnet.org/paths/strict-receive?destination_account=GAEDTJ4PPEFVW5XV2S7LUXBEHNQMX5Q2GM562RJGOQG7GVCE5H3HIB4V&source_account=GARSFJNXJIHO6ULUBK3DBYKVSIZE7SC72S5DYBCHU7DKL22UXKVD7MXP&destination_asset_type=native&destination_amount=20"
```
...
var destinationAsset = DiamnetSdk.Asset.native();
