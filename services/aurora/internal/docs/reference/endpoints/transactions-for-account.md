...
clientData:
  laboratoryUrl: https://www.hcnet.org/laboratory/#explorer?resource=transactions&endpoint=for_account
---
...
affect a given account as they get made in the HcNet network.
...
```sh
curl "https://aurora-testnet.hcnet.org/accounts/GBS43BF24ENNS3KPACUZVKK2VYPOZVBQO2CISGZ777RYGOPYC2FT6S3K/transactions?limit=1"
```
...
```json
{
  "_links": {
    "self": {
      "href": "https://aurora-testnet.hcnet.org/accounts/GBYUUJHG6F4EPJGNLERINATVQLNDOFRUD7SGJZ26YZLG5PAYLG7XUSGF/payments?cursor=&limit=10&order=asc"
    },
    "next": {
      "href": "https://aurora-testnet.hcnet.org/accounts/GBYUUJHG6F4EPJGNLERINATVQLNDOFRUD7SGJZ26YZLG5PAYLG7XUSGF/payments?cursor=2714719978786817&limit=10&order=asc"
    },
    "prev": {
      "href": "https://aurora-testnet.hcnet.org/accounts/GBYUUJHG6F4EPJGNLERINATVQLNDOFRUD7SGJZ26YZLG5PAYLG7XUSGF/payments?cursor=1919197546291201&limit=10&order=desc"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          ...
          "transaction": {
            "href": "https://aurora-testnet.hcnet.org/transactions/7e2050abc676003efc3eaadd623c927f753b7a6c37f50864bf284f4e1510d088"
          },
          "effects": {
            "href": "https://aurora-testnet.hcnet.org/operations/1919197546291201/effects"
          },
          "succeeds": {
            "href": "https://aurora-testnet.hcnet.org/effects?order=desc&cursor=1919197546291201"
          },
          "precedes": {
            "href": "https://aurora-testnet.hcnet.org/effects?order=asc&cursor=1919197546291201"
          }
        },
        "id": "1919197546291201",
      ...
      },
      {
        "_links": {
          "self": {
            "href": "https://aurora-testnet.hcnet.org/operations/2714719978786817"
          },
          "transaction": {
            "href": "https://aurora-testnet.hcnet.org/transactions/7cea6abe90654578b42ee696e823187d89d91daa157a1077b542ee7c77413ce3"
          },
          "effects": {
            "href": "https://aurora-testnet.hcnet.org/operations/2714719978786817/effects"
          },
          "succeeds": {
            "href": "https://aurora-testnet.hcnet.org/effects?order=desc&cursor=2714719978786817"
          },
          "precedes": {
            "href": "https://aurora-testnet.hcnet.org/effects?order=asc&cursor=2714719978786817"
          }
        },
        "id": "2714719978786817",
