...
* [regulated\-assets\-approval\-server](#regulated-assets-approval-server)
  ...
  * [Account Setup](#account-setup)
    * [GET /friendbot?addr=\{diamnet\_address\}](#get-friendbotaddrdiamnet_address)
  * [API Spec](#api-spec)
    * [POST /tx\-approve](#post-tx-approve)
    * [POST /kyc\-status/\{CALLBACK\_ID\}](#post-kyc-statuscallback_id)
    * [GET /kyc\-status/\{DIAMNET\_ADDRESS\_OR\_CALLBACK\_ID\}](#get-kyc-statusdiamnet_address_or_callback_id)
    * [DELETE /kyc\-status/\{DIAMNET\_ADDRESS\}](#delete-kyc-statusdiamnet_address)
...
configure-issuer`](#usage-configure-issuer) or [this Diamnet Laboratory
link](https://laboratory.diamnet.org/#txbuilder?params=eyJhdHRyaWJ1dGVzIjp7ImZlZSI6IjEwMCIsImJhc2VGZWUiOiIxMDAiLCJtaW5GZWUiOiIxMDAifSwiZmVlQnVtcEF0dHJpYnV0ZXMiOnsibWF4RmVlIjoiMTAwIn0sIm9wZXJhdGlvbnMiOlt7ImlkIjowLCJhdHRyaWJ1dGVzIjp7InNldEZsYWdzIjozfSwibmFtZSI6InNldE9wdGlvbnMifV19)
to set those flags.

After setting up the issuer account you can send some amount of the regulated
asset to a diamnet account using the servers friendbot
`friendbot/?addr={diamnet_address}` endpoint. The friendbot endpoint is not part
...
### `GET /friendbot?addr={diamnet_address}`
...
[this
link](https://laboratory.diamnet.org/#txbuilder?params=%3D%3D&network=test)
to do that in Diamnet Laboratory.
...
### `GET /kyc-status/{DIAMNET_ADDRESS_OR_CALLBACK_ID}`
...
```json
{
  "diamnet_address": "GA2DMTP67JT4LQ4CFTUONFBFGKPO6VONW4LWJNOIY2WPRJLUV44MJZOK",
...
### `DELETE /kyc-status/{DIAMNET_ADDRESS}`

Deletes a diamnet account from the list of KYCs. If the diamnet address is not
...
[SEP-8]: https://github.com/diamnet/diamnet-protocol/blob/7c795bb9abc606cd1e34764c4ba07900d58fe26e/ecosystem/sep-0008.md
[authorization flags]: https://github.com/diamnet/diamnet-protocol/blob/7c795bb9abc606cd1e34764c4ba07900d58fe26e/ecosystem/sep-0008.md#authorization-flags
[Action Required]: https://github.com/diamnet/diamnet-protocol/blob/7c795bb9abc606cd1e34764c4ba07900d58fe26e/ecosystem/sep-0008.md#action-required
[Rejected]: https://github.com/diamnet/diamnet-protocol/blob/master/ecosystem/sep-0008.md#rejected
[Revised]:https://github.com/diamnet/diamnet-protocol/blob/master/ecosystem/sep-0008.md#revised
[Success]: https://github.com/diamnet/diamnet-protocol/blob/master/ecosystem/sep-0008.md#success
[Pending]: https://github.com/diamnet/diamnet-protocol/blob/master/ecosystem/sep-0008.md#pending
