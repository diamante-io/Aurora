...
// in the backend.
func (c RemoteCaptiveDiamnetCore) GetLatestLedgerSequence(ctx context.Context) (sequence uint32, err error) {
...
func (c RemoteCaptiveDiamnetCore) PrepareRange(ctx context.Context, ledgerRange Range) error {
...
func (c RemoteCaptiveDiamnetCore) IsPrepared(ctx context.Context, ledgerRange Range) (bool, error) {
...
// GetLedger long-polls a remote diamnet core backend, until the requested
// ledger is ready.
...
func (c RemoteCaptiveDiamnetCore) GetLedger(ctx context.Context, sequence uint32) (xdr.LedgerCloseMeta, error) {
	for {
		// TODO: Have some way to cancel all outstanding requests, not just
		// PrepareRange.
		u := *c.url
