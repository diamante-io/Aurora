...
import (
	...
	xdr3 "github.com/diamnet/go-xdr/xdr3"
...
//
//   * Decouples buffering from diamnetCoreRunner so it can focus on running core.
//   * Decouples unmarshalling and buffering of LedgerCloseMeta's from CaptiveCore.
//   * By adding buffering it allows unmarshaling the ledgers available in Diamnet-Core
