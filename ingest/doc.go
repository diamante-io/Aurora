...
Very often developers need features that are outside of Aurora's scope. While
...
can be, for example: a Diamnet-Core database, (possibly-remote) Captive
Diamnet-Core instances, or History Archives. Please consult the "ledgerbackend"
...
guide: https://github.com/diamnet/go/blob/master/ingest/README.md
